    ...
    function loadProfileData() {
        ...
        getProfileInfo(function (result){
            $("#profile-information").append(
                ...
                //$('<button class="btn btn-primary" type="button" id="test-edit" name="edit">').text("Edit"),
                //$('<button class="btn btn-primary" type="submit" id="save" name="save" action>').text("Save").hide(),
                //$('<button class="btn btn-secondary" type="button" id="cancel" name="cancel" action>').text("Cancel").hide()
            )
        });
    }
