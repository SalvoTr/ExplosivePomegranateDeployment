...
public class IndexController {
    ...
    @GetMapping("/home")
    public String home() {
        return "Admin/book-search-admin.html";
    }
    ...
    public String profile() {
        return "Admin/profile-admin.html";
    }

    @Secured("ROLE_ADMIN")
    @GetMapping("/currentlyBorrowed")
    public String borrowed() {
        return "Admin/borrowed-books-overview.html";
    }

    @GetMapping("/myBorrowedBooks")
    public String myBorrowed() {
        return "Admin/my-borrowed-books-overview.html";
    }
    ...
    public String bookDetail(@PathVariable Long id) {
        return "../Admin/book-information-admin.html";
    }

    @Secured("ROLE_ADMIN")
    @GetMapping("/createNewBook")
    public String createBook() {
        return "Admin/add-new-book.html";
    }
}
